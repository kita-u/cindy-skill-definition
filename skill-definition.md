...
3. CindyScript 全体を **`encodeURIComponent`** し、ベース URL と連結する。
   - `https://ktky.sakura.ne.jp/file/cindyjs/cindy_csinit_query_plus.html?csinit=<encoded_script>`
...
```URL
https://ktky.sakura.ne.jp/file/cindyjs/cindy_csinit_query_plus.html?csinit=（CindyScript を encodeURIComponent した文字列）
```

ベース URL は必ず `https://ktky.sakura.ne.jp/file/cindyjs/cindy_csinit_query_plus.html` を使う。
